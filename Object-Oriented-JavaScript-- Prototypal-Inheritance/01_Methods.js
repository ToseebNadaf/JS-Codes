...
const person = {
  ...
  about: function aboutUS() {
    console.log(`person name is ${person.name}`, `person age is ${this.age}`);
  },
...
person.about(); //person name is raju person age is 23
...
person2.about(); //person name is rajesh person age is 29
